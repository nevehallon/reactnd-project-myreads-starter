            ...
            <div className="list-books-content">
              <div>
                <div className="bookgroup">
                  <h2 className="bookgroup-title">Currently Reading</h2>
                  <div className="bookgroup-books">
                ...
                <div className="bookgroup">
                  <h2 className="bookgroup-title">Want to Read</h2>
                  <div className="bookgroup-books">
                    <ol className="books-grid">
                      <li>
                        <div className="book">
                ...
                <div className="bookgroup">
                  <h2 className="bookgroup-title">Read</h2>
                  <div className="bookgroup-books">
                    <ol className="books-grid">
                      <li>
                        <div className="book">
